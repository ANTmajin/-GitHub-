...
class SettingsDialog(QDialog):
    ...
    def retranslate_ui(self):
        ...
        self.auto_save_checkbox.setText(Translator.get_translation(self.lang, "auto_save"))
...
class GitHubUploader(QMainWindow):
    ...
    def createMenuBar(self):
        ...
        langZhAction = QAction(Translator.get_translation(self.lang, "action_lang_zh"), self)
        langZhAction.triggered.connect(lambda: self.change_language("zh_CN"))
        languageMenu.addAction(langZhAction)
        
        langEnAction = QAction(Translator.get_translation(self.lang, "action_lang_en"), self)
